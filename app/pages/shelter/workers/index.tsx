          ...
          <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
            ...
            <tbody className="divide-y divide-gray-200">
              ...
              <tr>
                ...
                <td className="whitespace-nowrap px-4 py-2 text-gray-700 text-center">Web Designer</td>
                <td className="whitespace-nowrap px-4 py-2 text-gray-700 text-center">123 123 123</td>
